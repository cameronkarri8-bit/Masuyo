    ...
    faqs: [
      {
        ...
        a: 'Our starter websites are delivered within 7 working days. More complex websites or web applications typically take 2 to 6 weeks depending on scope. We will give you a clear timeline before any work begins.',
      },
      {
  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: 'Honest answer: 3 to 6 months is typical before you see meaningful organic traffic growth, though this depends heavily on your industry and competition. SEO is not a quick fix; it is a consistent, compounding strategy. We will always give you a realistic picture of what is achievable in your market.',
      },
      {
  ...
  return (
    <div style={{ borderBottom: '1px solid var(--border)' }}>
      <button
        ...
        onClick={() => setOpen(o => !o)}
      >
        <span className="text-sm font-semibold text-ink pr-4" style={{ lineHeight: '1.6' }}>{q}</span>
      ...
      <div className={`accordion-content ${open ? 'open' : ''}`}>
        <p className="pb-5 text-sm leading-relaxed" style={{ color: 'var(--mid)', lineHeight: '1.75' }}>{a}</p>
      </div>
    </div>
  )
}
