  ...
  return (
    ...
    <article className="py-16 md:py-24" style={{ marginTop: '64px' }}>
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Intro */}
        <p className="text-base mb-5 leading-relaxed" style={{ color: 'var(--mid)', lineHeight: '1.8' }}>
        ...
        <p className="text-base mb-10 leading-relaxed" style={{ color: 'var(--mid)', lineHeight: '1.8' }}>
        ...
        {/* Section 1 */}
        <h2 className="text-2xl font-semibold text-ink mt-10 mb-4">
        ...
        <div className="my-10 p-7 rounded-lg" style={{ background: 'var(--navy)' }}>
          ...
          <p className="text-sm mb-5" style={{ color: 'rgba(255,255,255,0.7)', lineHeight: '1.7' }}>
